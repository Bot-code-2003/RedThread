...
const PostSkeleton = () => {
  return (
    <>
      <div className="p-4 shadow-md w-full bg-white dark:bg-gray-800 rounded-lg animate-pulse">
        ...
        <div className="post-part-2 text-sm mb-1">
          <div className="flex justify-between flex-col sm:flex-row">
            ...
            <div className="tag w-auto bg-gray-200 h-4 w-24 rounded-md ml-1"></div>
          </div>
